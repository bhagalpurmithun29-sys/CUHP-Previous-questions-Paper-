            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="mt-1">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Are you sure you want to delete <span className="font-semibold text-gray-900">{schoolName}</span>? 
                  This action can be undone later from the archives, but it will immediately hide the school from users.
                </p>
              </div>
            </div>
